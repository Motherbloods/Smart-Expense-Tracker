...
function IncomeList({ incomes, onDeleteIncome, handleEditIncome }) {
    ...
    const confirmDelete = () => {
        if (incomeToDelete) {
            onDeleteIncome(incomeToDelete._id);
        }
                            ...
                            <div className="mt-4 text-center">
                                ...
                                <div className="mt-3">
                                    ...
                                    <p className="text-xs text-red-600 mt-2">
                                        Tindakan ini tidak dapat dibatalkan dan akan mempengaruhi perhitungan saldo.
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                .map((income) => (
                                    <tr key={income._id}>
                                        <td className="py-3 px-4">
                                            <div className="max-w-[120px] truncate" title={income.name}>
                                                {income.name}
                                            </div>
                                        </td>
                                        ...
                                        <td className="py-3 px-4">
                                            <div className="max-w-[150px] truncate text-gray-600" title={income.notes || '-'}>
                                                {income.notes || '-'}
                                            </div>
                                        </td>
                                        <td className="py-3 px-4 whitespace-nowrap">
                                        ...
                                        <td className="py-3 px-4 whitespace-nowrap">
                                            <div className="flex gap-2">
                                                <button onClick={() => handleEdit(income)} className="text-indigo-600 hover:text-indigo-900 cursor-pointer">
                                                    <Edit size={18} />
                                                </button>
                                                <button onClick={() => handleDeleteClick(income)} className="text-red-600 hover:text-red-900 cursor-pointer">
                                                    <Trash2 size={18} />
                                                </button>
                                            </div>
                                        </td>
                        ...
                        <div key={income._id} className="bg-white p-4 mb-2 rounded-md shadow-sm border border-gray-200">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <div className="flex space-x-2">
                                    ...
                                    <button onClick={() => handleDeleteClick(income)} className="text-red-600 hover:text-red-900">
                                        <Trash2 size={16} />
                                    </button>
                                </div>
                            </div>
